...
<li class="nav-items">
<a href="./deletepage" class="nav-link" ><font color="white">Delete</font></a>
</li>
...
<form class="navbar-form navbar-left" action="searchfordelete" method="get">
      <div class="input-group">
        <input type="text" class="form-control" placeholder="Search To Delete" name="keyword" required>
        <div class="input-group-btn">
          <button class="btn btn-default" type="submit">
            <i class="glyphicon glyphicon-search"></i>
          </button>
...
<div align = "left">	<h3>Delete Records</h3> </div>
	<table border="1" width="100%">
		...
		<tr>
			...
			<td>	
				<a href="delete?id=${view.phone}">Delete</a>
			</td>
		</tr>
